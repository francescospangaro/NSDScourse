...
public class BasicConsumerManual {
    ...
    private static final boolean autoCommit = false; //Non aggiorno in automatico gli offsets del consumer a kafka
        ...
        while (true) {
            ...
            for (final ConsumerRecord<String, String> record : records) {
                ...
                if (numConsumed == commitEvery) {
                    //Commit dell'offset fatto dopo aver letto 'commitEvery' msgs
                    numConsumed = 0;
